...
test('success rate downgrades failing models only with sufficient samples', () => {
  ...
  const b = { id: 'healthy-alternative', capability: 85, economy: 70, purpose: 'general', tools: true };
